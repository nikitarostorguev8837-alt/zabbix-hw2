# Домашнее задание к занятию "`Система мониторинга Zabbix. Часть 2`" - `Росторгуев Никита`
   
### Задание 1. Создайте свой шаблон, в котором будут элементы данных, мониторящие загрузку CPU и RAM хоста.

Скриншот:
![Скриншот](https://github.com/nikitarostorguev8837-alt/zabbix-hw/blob/main/img/task_1-1.png)
...
Скриншот:
![Скрин1](https://github.com/nikitarostorguev8837-alt/zabbix-hw/blob/main/img/task_3-1.png)
